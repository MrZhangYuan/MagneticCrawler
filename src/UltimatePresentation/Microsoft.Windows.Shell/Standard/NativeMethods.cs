namespace Standard
{
    ...
    internal sealed class SafeFindHandle : SafeHandleZeroOrMinusOneIsInvalid
    {
        ...
        {
            return NativeMethodsShell.FindClose(handle);
        }
    }
    ...
    internal sealed class SafeHBITMAP : SafeHandleZeroOrMinusOneIsInvalid
    {
        ...
        protected override bool ReleaseHandle()
        {
            return NativeMethodsShell.DeleteObject(handle);
        }
    }
    ...
    internal sealed class SafeGdiplusStartupToken : SafeHandleZeroOrMinusOneIsInvalid
    {
        ...
        protected override bool ReleaseHandle()
        {
            Status s = NativeMethodsShell.GdiplusShutdown(this.handle);
            return s == Status.Ok;
        }
        ...
        public static SafeGdiplusStartupToken Startup()
        {
            ...
            Status s = NativeMethodsShell.GdiplusStartup(out unsafeHandle, new StartupInput(), out output);
            if (s == Status.Ok)
            {
